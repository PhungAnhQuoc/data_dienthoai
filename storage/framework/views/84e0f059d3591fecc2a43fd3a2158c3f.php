                        ...
                        <div class="card-body">
                            ...
                            <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="d-flex align-items-center py-3 border-bottom">
                                    ...
                                    <div class="text-end">
                                        <div><?php echo e(number_format($item->unit_price * $item->quantity, 0, ',', '.')); ?>₫</div>
                                    </div>
                                </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-6 text-end fw-bold"><?php echo e(number_format($order->total_amount - ($order->shipping_cost ?? 0) - ($order->tax_amount ?? 0), 0, ',', '.')); ?>₫</div>
