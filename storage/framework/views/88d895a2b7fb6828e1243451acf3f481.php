            ...
            <tr>
                ...
                <td>
                    <div class="customer-info">
                        <span class="customer-name"><?php echo e($order->shipping_name); ?></span>
                        <span class="customer-email"><?php echo e($order->user->email ?? $order->shipping_email); ?></span>
                    </div>
                </td>
                <td>
                    <span class="order-amount"><?php echo e(number_format($order->total_amount, 0, ',', '.')); ?>đ</span>
                </td>
                <td>
                    <span class="badge-custom badge-cyan"><?php echo e($order->items->count()); ?> Items</span>
                </td>
                <td>
                ...
                <td>
                    <a href="<?php echo e(route('admin.orders.show', $order->id)); ?>" class="action-btn" title="View Details">
