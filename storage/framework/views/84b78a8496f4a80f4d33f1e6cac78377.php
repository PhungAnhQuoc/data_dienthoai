...
<div class="blog-header">
    <div class="container">
        <nav class="breadcrumb" style="margin-bottom: 20px;">
            <a href="<?php echo e(route('home')); ?>" class="breadcrumb-item">Home</a>
                ...
                <?php if($posts->count() > 0): ?>
                    ...
                    <div class="featured-post mb-5">
                        ...
                        <div class="featured-content">
                            ...
                            <h2 class="featured-title"><?php echo e($featured->title); ?></h2>
                            <p class="featured-excerpt"><?php echo e(Str::limit($featured->excerpt ?? $featured->content, 150)); ?></p>
                            <a href="<?php echo e(route('blog.show', $featured->slug)); ?>" class="btn btn-primary">
                                Read Full Review
                    ...
                    <div class="recent-articles">
                        ...
                        <div class="articles-grid">
                            <?php $__empty_1 = true; $__currentLoopData = $posts->skip(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <article class="article-card">
                                    ...
                                    <div class="article-content">
                                        <div class="article-meta">
                                            ...
                                            <span class="article-date"><?php echo e($post->published_at->format('M d, Y')); ?></span>
                                        </div>
                                        <h4 class="article-title">
                                            <a href="<?php echo e(route('blog.show', $post->slug)); ?>"><?php echo e($post->title); ?></a>
                                        </h4>
                                        <p class="article-excerpt"><?php echo e(Str::limit($post->excerpt ?? $post->content, 80)); ?></p>
