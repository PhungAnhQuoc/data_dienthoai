            ...
            <div class="card-body" style="padding: 24px;">
                <div class="d-flex justify-content-between align-items-center">
                    <div style="flex: 1;">
                        ...
                        <h2 class="mb-0" style="color: white; font-size: 36px; font-weight: 700;"><?php echo e($stats['total_products'] ?? 0); ?></h2>
                    </div>
            ...
            <div class="card-body" style="padding: 24px;">
                <div class="d-flex justify-content-between align-items-center">
                    <div style="flex: 1;">
                        ...
                        <h2 class="mb-0" style="color: white; font-size: 36px; font-weight: 700;"><?php echo e($stats['total_orders'] ?? 0); ?></h2>
                    </div>
            ...
            <div class="card-body" style="padding: 24px;">
                <div class="d-flex justify-content-between align-items-center">
                    <div style="flex: 1;">
                        ...
                        <h2 class="mb-0" style="color: white; font-size: 36px; font-weight: 700;"><?php echo e($stats['sold_count'] ?? 0); ?></h2>
                    </div>
            ...
            <div class="card-body" style="padding: 24px;">
                <div class="d-flex justify-content-between align-items-center">
                    <div style="flex: 1;">
                        ...
                        <h2 class="mb-0" style="color: #333; font-size: 36px; font-weight: 700;"><?php echo e(number_format($stats['total_revenue'] ?? 0, 0, ',', '.')); ?>đ</h2>
                    </div>
        ...
        <div class="card" style="border: none; border-radius: 12px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);">
            <div class="card-header bg-white border-bottom" style="border-radius: 12px 12px 0 0; padding: 20px; border-bottom: 1px solid #e8edf2;">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('admin.orders.index')); ?>" class="btn btn-sm" style="background: linear-gradient(135deg, #1e3a8a 0%, #1e40af 100%); color: white; border: none; border-radius: 6px; padding: 6px 16px; font-size: 13px; font-weight: 500;">Xem tất cả</a>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid #e8edf2;">
                            <td style="padding: 12px 16px; color: #2c3e50; font-weight: 500;">
                                <?php echo e($order->user->name ?? 'Khách hàng'); ?>

                            </td>
                            <td style="padding: 12px 16px; color: #2c3e50; font-weight: 600;">
                                <?php echo e(number_format($order->total_amount ?? 0, 0, ',', '.')); ?>₫
                            </td>
                            <td style="padding: 12px 16px;">
                                ...
                                ?>
                                <span class="badge" style="background-color: <?php echo e($status[1]); ?>; color: white; padding: 4px 10px; border-radius: 4px; font-size: 12px; font-weight: 500;">
                                    <?php echo e($status[0]); ?>

                                </span>
                            </td>
                            <td style="padding: 12px 16px; color: #666; font-size: 13px;">
                                <?php echo e($order->created_at->format('Y-m-d H:i:s')); ?>

                            </td>
                            <td style="padding: 12px 16px;">
                                <a href="<?php echo e(route('admin.orders.show', $order->id)); ?>" style="color: #1e3a8a; text-decoration: none; font-size: 13px; font-weight: 500;">
