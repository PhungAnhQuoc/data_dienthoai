...
<div class="page-header">
    <div>
        ...
        <p class="text-muted">Order placed on <?php echo e($order->created_at->format('M d, Y H:i')); ?></p>
    </div>
                    ...
                    <table class="table table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e(number_format($price, 0, ',', '.')); ?>đ</td>
                                <td><strong><?php echo e(number_format($totalPrice, 0, ',', '.')); ?>đ</strong></td>
                            </tr>
                    ...
                    <div class="col-md-6 ms-auto">
                        <table class="table table-sm table-borderless">
                            <tr>
                                ...
                                <td class="text-end"><?php echo e(number_format($order->total_amount - $order->shipping_cost - $order->tax_amount, 0, ',', '.')); ?>đ</td>
                            </tr>
                            <tr>
                                <td><strong>Tax:</strong></td>
                                <td class="text-end"><?php echo e(number_format($order->tax_amount, 0, ',', '.')); ?>đ</td>
                            </tr>
                            <tr>
                            ...
                            <tr style="border-top: 2px solid #e9ecef;">
                                ...
                                <td class="text-end"><strong class="text-primary" style="font-size: 1.2rem;"><?php echo e(number_format($order->total_amount, 0, ',', '.')); ?>đ</strong></td>
                            </tr>
                        </table>
                    </div>
                </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                <p>
                    ...
                    <?php echo e($order->shipping_email ?? $order->user->email); ?>
                ...
                <?php if($order->user): ?>
                <p>
                    <small class="text-muted">Registered as: <a href="#"><?php echo e($order->user->name); ?></a></small>
                </p>
                <?php endif; ?>
            </div>
        </div>
