<?php $__env->startSection('title', 'Đăng nhập - MobileShop'); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <a href="<?php echo e(route('password.request')); ?>" class="text-primary text-decoration-none small">Quên mật khẩu?</a>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mobile-shop-master\resources\views/auth/login-new.blade.php ENDPATH**/ ?>