<footer class="site-footer bg-white text-dark pt-5 mt-4 border-top">
    <div class="container">
        <div class="row gy-4">
            ...
            <div class="col-md-2">
                ...
                <ul class="list-unstyled small">
                    <li><a href="{{ route('home') }}" class="text-dark text-decoration-none">Trang chủ</a></li>
                    <li><a href="{{ route('products.index') }}" class="text-dark text-decoration-none">Sản phẩm</a></li>
                    <li><a href="{{ route('blog.index') }}" class="text-dark text-decoration-none">Tin tức</a></li>
                    <li><a href="{{ route('contact.index') }}" class="text-dark text-decoration-none">Liên hệ</a></li>
                </ul>
            </div>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between small text-muted">
            <div>&copy; {{ date('Y') }} {{ config('app.name') }}. Đã đăng ký Bản quyền.</div>
