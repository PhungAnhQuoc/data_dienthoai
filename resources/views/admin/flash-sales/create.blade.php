                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  placeholder="Mô tả ngắn về sản phẩm flash sale...">{{ old('description') }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('stock') is-invalid @enderror" 
                                   name="stock" value="{{ old('stock') }}" min="1" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                <input type="color" class="form-control form-control-color @error('color_badge') is-invalid @enderror" 
                                       name="color_badge" value="{{ old('color_badge', '#FF6B6B') }}" required>
                                <input type="text" class="form-control" value="{{ old('color_badge', '#FF6B6B') }}" readonly>
                            </div>
