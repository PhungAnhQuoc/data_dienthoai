...
@section('title', 'Thêm mã ưu đãi - Admin')
...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="mb-0">
                <i class="bi bi-plus-circle"></i> Thêm mã ưu đãi mới
            </h2>
        </div>
    </div>
                    ...
                    <form action="{{ route('admin.promotions.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="3"
                                      placeholder="Mô tả chi tiết về mã ưu đãi...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-2"></i>Tạo mã ưu đãi
                            </button>
