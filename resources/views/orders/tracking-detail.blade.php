...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="mb-4">
                <a href="{{ route('orders.tracking') }}" class="btn btn-outline-secondary btn-sm">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h4>Mã đơn hàng: <strong>{{ $order->order_number }}</strong></h4>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <strong>{{ number_format($order->total_amount - ($order->shipping_cost ?? 0) - ($order->tax_amount ?? 0), 0, ',', '.') }}₫</strong>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                                <span class="text-muted">Phí vận chuyển:</span>
                                <strong>{{ number_format($order->shipping_cost ?? 0, 0, ',', '.') }}₫</strong>
                            </div>
                            <div class="d-flex justify-content-between mb-3">
                                <span class="text-muted">Thuế:</span>
                                <strong>{{ number_format($order->tax_amount ?? 0, 0, ',', '.') }}₫</strong>
                            </div>
                            <hr>
            ...
            <div class="mt-4">
                <a href="{{ route('orders.tracking') }}" class="btn btn-outline-secondary">
